...
def run_mcp_planner(user_query: str, df: pd.DataFrame, chat_history: List[Dict] = None) -> Dict[str, Any]:
    ...
    prompt = ChatPromptTemplate.from_messages([
        ("system",
         ...
         "   - **IMPORTANT:** If steps 1-3 involve multiple complex operations, ask for permission first\n\n"
         "PRIORITY GUIDELINES:\n"
         ...
         "14. **CRITICAL: Ask for user permission before complex multi-step operations (see USER PERMISSION PROTOCOL)**\n"
         "15. Keep the user informed about what you're doing to maintain engagement and trust\n\n"
